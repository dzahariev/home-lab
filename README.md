...
- **[Cluster](cluster/README.md)** — K3s Kubernetes cluster running on bare metal Mac Mini nodes. Hosts applications exposed to the internet with TLS termination, managed via ArgoCD and Kustomize.
